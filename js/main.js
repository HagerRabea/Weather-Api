...
//  let arrtoday=data.forecast.forecastday[0].hour;
  ...
  //  if(arrtoday[i].time==date1){
  //    console.log("true");
  //     toText=arrtoday[i].condition.text;
  //     todMaxTem=  arrtoday[i].temp_c;
  //     todMaxWind=  arrtoday[i].wind_kph;
  //     todWillRain=arrtoday[i].will_it_rain;
  //     todayWindDir=arrtoday[i].wind_dir;
  //     todIconCode=arrtoday[i].condition.code;
  //     todIsDay=arrtoday[i].is_day;
  //  }
  // }
  if(todIsDay==0){
    file="day";
...
////////////////////today////////////////////////
 ...
 todayIcon.setAttribute("src",`weather/64x64/${file}/${toiconNum}.png`);
...
/////////////////////////aftom/////////////////////////////////////////////
 ...
 afTomIcon2.setAttribute("src",`weather/64x64/day/${toiconNum2}.png`);
